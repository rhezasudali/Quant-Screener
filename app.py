    ...
    with st.spinner(f"Menganalisa {ticker}..."):
        ...
        if hist.empty:
            ...
            with tab1:
                ...
                with c2:
                    ...
                    fig_chart.update_layout(
                        ...
                        paper_bgcolor="#08090d", plot_bgcolor="#12141d",
                        font=dict(color="#8a8d9e", family="DM Sans"),
                        height=300, margin=dict(l=10, r=10, t=40, b=10),
                        xaxis=dict(showgrid=False), yaxis=dict(showgrid=True, gridcolor="#1f2233")
                    )
                ...
                <div class='risk-card'>
                    ...
                    <div class='data-font {growth_status}'>Rev: {round(rev_g_val*100, 2) if isinstance(rev_g_val, float) else rev_g_val}%</div>
                    <div class='data-font neutral'>EPS: {round(eps_g_val*100, 2) if isinstance(eps_g_val, float) else eps_g_val}%</div>
                </div>
                """, unsafe_allow_html=True)
            ...
            with tab2:
                ...
                st.markdown("<div class='label-font' style='margin-top:20px;'>Laporan Teks (Export to Clipboard)</div>", unsafe_allow_html=True)
